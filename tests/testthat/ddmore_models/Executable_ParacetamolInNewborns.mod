...
TIME ; in min
AMT  ; in mg
;RATE ; in mg/min (NLUY: REMOVE RATE for Pharmpy)
...
COMP=COMP2             ;PLASMA APAP-G (NLUY: ADD CMT NAME)
COMP=COMP3             ;PLASMA APAP-S (NLUY: ADD CMT NAME)
COMP=COMP4             ;URINE APAP-G  (NLUY: ADD CMT NAME)
COMP=COMP5             ;URINE APAP    (NLUY: ADD CMT NAME)
COMP=COMP6             ;URINE APAP-S  (NLUY: ADD CMT NAME) 
